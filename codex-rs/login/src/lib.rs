...
pub use github_copilot::GITHUB_COPILOT_CLIENT_ID_ENV_VAR;
pub use github_copilot::GITHUB_COPILOT_DEFAULT_CLIENT_ID;
pub use github_copilot::GitHubCopilotDeviceCode;
pub use github_copilot::GitHubCopilotLoginOptions;
pub use github_copilot::complete_github_copilot_device_code_login;
pub use github_copilot::request_github_copilot_device_code;
...
pub use auth::GitHubCopilotAuth;
...
pub use auth::login_with_github_copilot;
pub use auth::logout;
